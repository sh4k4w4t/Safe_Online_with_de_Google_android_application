...
public class ChatAppsAdapter extends RecyclerView.Adapter<ChatAppsAdapter.MyHolder> {

    Context context;
    ArrayList<HomeItemGridPojo> arrayList;

    public ChatAppsAdapter(Context context, ArrayList<HomeItemGridPojo> arrayList) {
