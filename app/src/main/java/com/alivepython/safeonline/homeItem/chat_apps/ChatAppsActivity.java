package com.alivepython.safeonline.homeItem.chat_apps;
...
public class ChatAppsActivity extends AppCompatActivity {
    ArrayList<HomeItemGridPojo> arrayList;
    RecyclerView recyclerView;
    ChatAppsAdapter item_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_apps);
        this.setTitle("Best Chat Apps");
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(ChatAppsActivity.this, 3);
        gridLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(gridLayoutManager);

        item_adapter = new ChatAppsAdapter(ChatAppsActivity.this, arrayList);
    ...
    private void gridListData() {
        ...
        arrayList.add(new HomeItemGridPojo("Telegram", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Signal", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Skype", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Session", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Threema", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("WeChat", R.drawable.test_image));
    }
