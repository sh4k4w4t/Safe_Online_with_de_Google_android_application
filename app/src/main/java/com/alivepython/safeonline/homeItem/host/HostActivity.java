package com.alivepython.safeonline.homeItem.host;
...
public class HostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(HostActivity.this, 3);
        gridLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(gridLayoutManager);

        item_adapter = new HostAdapter(HostActivity.this, arrayList);
    ...
    private void gridListData() {
        ...
        arrayList.add(new HomeItemGridPojo("AliBaba", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Amazon", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("Blue Host", R.drawable.test_image));
        arrayList.add(new HomeItemGridPojo("NameCheap", R.drawable.test_image));
    }
