...
public class RemoteAdapter extends RecyclerView.Adapter<RemoteAdapter.MyHolder> {

    Context context;
    ArrayList<HomeItemGridPojo> arrayList;

    public RemoteAdapter(Context context, ArrayList<HomeItemGridPojo> arrayList) {
