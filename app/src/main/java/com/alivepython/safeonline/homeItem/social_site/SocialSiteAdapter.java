...
public class SocialSiteAdapter extends RecyclerView.Adapter<SocialSiteAdapter.MyHolder> {

    Context context;
    ArrayList<HomeItemGridPojo> arrayList;

    public SocialSiteAdapter(Context context, ArrayList<HomeItemGridPojo> arrayList) {
